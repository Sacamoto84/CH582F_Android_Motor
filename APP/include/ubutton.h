 ...
 *
 * Тайминги и последовательность состояний сохранены, чтобы поведение кнопки
 * для пользователя совпадало с прошивкой на CH32V003. Отличие в реализации:
 * там C++ и millis(), здесь C и шаг тика.
 *
...
#define UB_HOLD_TIME    2000    /* до состояния «удержание» */
