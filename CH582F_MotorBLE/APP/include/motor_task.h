...
/* Минимальная пауза между остановкой и следующим пуском. Пачка бросков
 * подряд бьёт по питанию заметно сильнее одиночного пуска: каждый старт
 * это рывок 80 % скважности в неподвижный ротор. Запрос на пуск при этом
 * не теряется — он исполнится, как только пауза выдержана. */
#define MOTOR_RESTART_MS        500
