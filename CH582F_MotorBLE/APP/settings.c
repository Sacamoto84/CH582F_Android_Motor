...
void Settings_Defaults(void)
{
    ...
    g_set.boost_en       = 1;
    /* +20 % к рабочей скважности. Прибавка, а не абсолютное значение:
     * рывок должен быть соразмерен режиму, а не одинаковым на любой
     * мощности. Сумма зажимается по 1000. */
    g_set.boost_power    = 200;
